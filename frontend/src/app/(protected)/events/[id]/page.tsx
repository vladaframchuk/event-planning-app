...
const EventDetailsPage = () => {
  ...
  if (eventQuery.isError || !eventQuery.data) {
    return (
      <section className="mx-auto max-w-3xl rounded-xl border border-red-200 bg-red-50 p-6 text-red-600 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300">
        <h1 className="text-xl font-semibold">Не удалось получить данные события</h1>
        <p className="mt-2 text-sm">
          {eventQuery.error?.message ?? 'Попробуйте перезагрузить страницу или вернитесь к списку событий.'}
        </p>
  ...
  return (
    <>
      {toastVisible ? (
        <div className="mx-auto mb-4 w-full max-w-2xl rounded-lg bg-green-600 px-4 py-2 text-center text-sm font-medium text-white shadow-lg">
          Приглашение принято, участник добавлен к событию.
        </div>
      ) : null}

      <section className="flex w-full flex-col gap-4 px-4 sm:px-6 lg:px-10">
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950">
              ...
              <p className="mt-1 text-sm text-neutral-800 dark:text-neutral-200">{startAt ?? 'Не указано'}</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950">
              <p className="text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400">
                Дата завершения
              </p>
              <p className="mt-1 text-sm text-neutral-800 dark:text-neutral-200">{endAt ?? 'Не указано'}</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-950">
              <p className="text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400">
                Локация
