...
@receiver(
    pre_delete,
    sender=Participant,
    dispatch_uid="participant_pre_delete_organizer_guard",
)
def prevent_last_organizer_delete(
    sender: type[Participant], instance: Participant, **_: Any
) -> None:
...
@receiver(
    pre_save, sender=Participant, dispatch_uid="participant_pre_save_organizer_guard"
)
def prevent_last_organizer_demotion(
    sender: type[Participant], instance: Participant, **_: Any
) -> None:
    if not instance.pk:
        return
